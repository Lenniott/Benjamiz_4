...
export function Container({ 
  ...
  const variants = {
    global: `flex ${isHorizontal} p-4 sm:p-6  items-right justify-start `, // Use template literal for dynamic col value
    solid: "rounded-lg bg-card p-4 sm:p-6",
    linear: "rounded-lg bg-gradient-to-r from-card from-40% to-transparent to-80% p-4 sm:p-6",
    clear: "",
  };
