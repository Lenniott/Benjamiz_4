...
>(({ className, ...props }, ref) => (
  <SheetPrimitive.Overlay
    className={cn(
      "fixed inset-0 z-50 bg-background/95 backdrop-blur-lg data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0",
      className
    )}
    {...props}
    ref={ref}
...
>(({ side = "right", className, children, ...props }, ref) => (
  <SheetPortal>
    ...
    ref={ref}
    className={cn(
      "flex flex-col", // Add flex container properties here
      sheetVariants({ side }),
      className
    )}
    {...props}
